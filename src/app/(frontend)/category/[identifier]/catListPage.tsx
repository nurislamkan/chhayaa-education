...
const CategoryWisePostList = async ({
  viewMode,
  posts,
}: {
  viewMode:"list" | "grid";
  posts: Promise<{ products: any[]; categoryName: string }>;
}) => { 
  const {products, categoryName} = await posts; 
...
export default CategoryWisePostList;
